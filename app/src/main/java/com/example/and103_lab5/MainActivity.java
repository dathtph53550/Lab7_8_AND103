...
public class MainActivity extends AppCompatActivity implements DistributorAdapter.DistributorClick {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()) {
                    ...
                    httpRequest.callAPI()
                            ...
                            .enqueue(new Callback<Response<ArrayList<Distributor>>>() {
                                @Override
                                public void onResponse(Call<Response<ArrayList<Distributor>>> call, retrofit2.Response<Response<ArrayList<Distributor>>> response) {
                                    if(response.isSuccessful()){
                                        if(response.body().getStatus() == 200){
                                            ...
                                            adapter = new DistributorAdapter(list, MainActivity.this,MainActivity.this );
                                            binding.rcvDistributor.setAdapter(adapter);
    ...
    Callback<Response<ArrayList<Distributor>>> addDistributorAPI = new Callback<Response<ArrayList<Distributor>>>() {
        @Override
        public void onResponse(Call<Response<ArrayList<Distributor>>> call, retrofit2.Response<Response<ArrayList<Distributor>>> response) {
            if(response.isSuccessful()){
                if(response.body().getStatus() == 200){
